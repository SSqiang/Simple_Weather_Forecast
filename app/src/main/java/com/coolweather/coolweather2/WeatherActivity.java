package com.coolweather.coolweather2;
...
import com.coolweather.coolweather2.db.County;
import com.coolweather.coolweather2.gson.Forecast;
import com.coolweather.coolweather2.gson.Weather;
import com.coolweather.coolweather2.util.HttpUtil;
import com.coolweather.coolweather2.util.Utility;
...
public class WeatherActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String s = prefs.getString("countyName","崇阳,");
        String sw = prefs.getString("weatherId","CN101200704.");
...
//                SharedPreferences.Editor editor=PreferenceManager.
//                        getDefaultSharedPreferences(WeatherActivity.this).edit();
//                editor.putString("weatherId","CN101200704.");
//                editor.putString("countyName","崇阳,");
//                editor.apply();
            }
        });
